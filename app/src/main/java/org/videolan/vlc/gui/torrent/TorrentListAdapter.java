...
public class TorrentListAdapter extends RecyclerView.Adapter<TorrentListAdapter.ViewHolder> {
    ...
    private TorrentBrowserFragment mFragment;
    ...
    public TorrentListAdapter(TorrentBrowserFragment fragment) {
        super();
        mFragment = fragment;
    }
