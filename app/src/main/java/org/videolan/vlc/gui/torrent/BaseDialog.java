...
public class BaseDialog extends DialogFragment {
    ...
    public final static String TAG = "VLC/BaseDialog";
    ...
    public static BaseDialog newInstance(String title, String message, int resIdView,
    ...
    protected AlertDialog.Builder buildDialog(final String title, final String message,
        ...
        if (positiveText != null) {
            dialog.setPositiveButton(positiveText, (d, which) -> {
                if (getTargetFragment() != null) {
        ...
        if (negativeText != null) {
            dialog.setNegativeButton(negativeText, (d, which) -> {
                if (getTargetFragment() != null) {
                    if (getTargetFragment() instanceof OnClickListener) {
        ...
        if (neutralText != null) {
            dialog.setNeutralButton(neutralText, (d, which) -> {
                if (getTargetFragment() != null) {
                    if (getTargetFragment() instanceof OnClickListener) {
