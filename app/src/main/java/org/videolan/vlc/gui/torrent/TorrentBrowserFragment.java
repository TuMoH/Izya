...
public class TorrentBrowserFragment extends MediaBrowserFragment implements ISortable, IVideoBrowser, SwipeRefreshLayout.OnRefreshListener {

    public final static String TAG = "VLC/TorrentFragment";
    ...
    private TorrentListAdapter mVideoAdapter;
    ...
    public TorrentBrowserFragment() { }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        mVideoAdapter = new TorrentListAdapter(this);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        View v = inflater.inflate(R.layout.torrent_browser, container, false);
            ...
            case R.id.video_list_play_all:
                ...
                for (int i = 0; i < videos.size(); ++i) {
                    ...
                    if (mw instanceof MediaGroup) {
                        playList.addAll(((MediaGroup) mw).getAll());
                        if (i < position)
        ...
        if (itemList.size() > 0) {
            VLCApplication.runBackground(() -> {
                ...
                if (mThumbnailer != null && !jobsList.isEmpty()) {
                    mThumbnailer.clearJobs();
                    mThumbnailer.start(TorrentBrowserFragment.this);
